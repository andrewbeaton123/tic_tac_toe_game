...
class TestTicTacToe(unittest.TestCase):
    def test_reset(self):
        ...
        game = TicTacToe(starting_player=2, board=np.array([[1, 2, 0], 
                                                            [0, 1, 2],
                                                            [2, 1, 0]]))
    ...
    def test_get_valid_moves(self):
        ...
        game = TicTacToe(starting_player=1, board=np.array([[1, 2, 0], 
                                                            [0, 1, 2],
                                                            [2, 1, 0]]))
    ...
    def test_invalid_move(self):
        ...
        game = TicTacToe(starting_player=1, board=np.array([[1, 0, 0], 
                                                            [0, 0, 0],
                                                            [0, 0, 0]]))
    ...
    def test_check_winner(self):
        ...
        game = TicTacToe(starting_player=1, board=np.array([[1, 1, 1], 
                                                            [0, 2, 0],
                                                            [0, 0, 2]]))
